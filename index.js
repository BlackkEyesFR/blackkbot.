...
client.login("NDk3NzcxNDc4ODMwMjg0ODAw.DpkKOA.JAAu8NLv47_jETmaeYcPXVcJRfc");
...
client.on('message', message=> {
    ...
    if(message.content === prefix + "aide"){
        ...
        .addField("*mute", "Mute l'utilisateur indiqué.")
        .addField("*unmute", "UnMute l'utilisateur indiqué.")
        .addField("*warn", "Ajoute un avertissement à l'utilisateur indiqué.")
        .addField("*deletewarns", "Supprime un avertissement à l'utilisateur indiqué.")
        .addField("*seewarns", "Voir les avertissements de l'utilisateur indiqué.")
        .setFooter("Menu d'aide - BlackkBot")
